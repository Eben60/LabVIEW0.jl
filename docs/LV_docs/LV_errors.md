...
**5235828** | _err_ | please define byte order for this platform
**5235829** | _warn_ | LVServer or LabVIEW0 or LV2Julia_core.lvlib not the last version available, see warning in Julia server terminal output
